...
note=(cyan+"Note: I wont be responsible fo any illigal activites. >> This RedBomberBD tool is for use in Bangladesh only. Use our Global version for worldwide use.")
